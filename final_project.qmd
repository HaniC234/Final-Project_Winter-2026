...
housing_age['old_housing_share'] = ((housing_age['old_units'] 
  / housing_age['total_units']))

housing_age = (housing_age[['GEOID', 'NAME', 'total_units', 
  'old_units', 'old_housing_share']])
...
home_value['median_home_value'] = (pd.to_numeric(home_value['median_home_value'], 
  errors='coerce'))
...
gdfs = ({"income_24c": gdf_income, "renter_24c": gdf_renter, 
  "house_age_24c": gdf_age, "home_value_24c": gdf_home})
chicago_gdfs = {} 
...
print(env[["lst_summer_mean","ndvi_mean","impervious_mean","road_density",
  "tri_release_total"]].describe())
```
...
chart.save('scatter.png', scale_factor = 2)
Image('scatter.png')
```
